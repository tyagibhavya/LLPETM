/*
Defining the macros for convenience :CH 4.
*/
...
/*
ASSERT function is designed for runtime assertions.
If the provided condition (cond) is false, it outputs a
custom error message to the standard error stream and terminates
the program with an exit code indicating failure. The use
of UNLIKELY suggests that the function is optimized for
cases where assertions are likely to fail infrequently. The
noexcept specifier emphasizes that the function does not throw exceptions.
*/
