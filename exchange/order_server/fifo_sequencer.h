...
/*
Source code to initialize the FIFO sequencer.
*/
    ...
    public:
        ...
        auto sequenceAndPublish(){
            ...
            for(size_t i = 0 ; i < pending_size_ ; ++i){
                ...
                Common::getCurrentTimeStr(&time_str_),client_request.recv_time_, client_request.request_.toString());
